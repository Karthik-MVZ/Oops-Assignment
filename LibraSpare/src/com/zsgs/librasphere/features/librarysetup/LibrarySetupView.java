...
import com.zsgs.librasphere.features.librarysetup.details.LibraryDetailsView;
    ...
    public void showMainMenu() {
        while (true) {
            ...
            try {
                ...
                switch (choice) {
                    case 1:
                        new com.zsgs.librasphere.features.books.manage.ManageView().init();
                        break;
                    case 2:
                        new com.zsgs.librasphere.features.books.BooksView().init();
                        break;
                    case 3:
                        new com.zsgs.librasphere.features.users.manage.ManageView().init();
                        break;
                    case 4:
                        new com.zsgs.librasphere.features.users.UsersView().init();
                        break;
                    case 5:
                    ...
                    case 6:
                        ...
                        new com.zsgs.librasphere.features.registration.RegistrationView().init();
                        return;
                    case 7:
                        exitApp();
                    default:
